(function() {
  ...
  _.reject = function(collection, test) {
    ...
    // copying code in and modifying itc
  ...
  _.uniq = function(array, isSorted, iterator) {
    ...
    var iteratedArray = _.map(array, function(item) {
      return iterator(item);
    });
    _.each(iteratedArray, function(item, index) {
      if (_.indexOf(uniqTest, item) === -1) {
  ...
  _.uniq = function(array, isSorted, iterator) {
    ...
    var uniqResult = [];
    _.each(mySet, function(property) {
      uniqResult.push(iterator(property);
    });
    return uniqResult;
  }
...
*/
  ...
  _.delay = function(func, wait) {
    var parameters = Object.values(arguments).slice(2);
    setTimeout(function() {
